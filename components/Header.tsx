...
export default function Header() {
    return (
        <header className={scss.header}>
            <div className={scss.logoInHeader}>
                <Image  width="80" src={logo} alt="LOGO" />
                <h1 className={scss.titleInHeader}>Besser Wohnen</h1>
            </div>
            <a className="header snipcart-summary snipcart-checkout" href="#">
                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                    width="30" height="auto" viewBox="0 0 512.000000 512.000000"
...
-36 -266 0 -164 83 -210 284 -101 442 73 105 231 146 356 91z"/>
                ...
                <span className=" snipcart-total-price header margin-right-auto"></span>
            </a>
        </header>
    )
}